<?php
    ...
    $PortId = $_GET['user_id'];
    $select = "SELECT * FROM portfolios WHERE id = $PortId";
      ...
      <a class="breadcrumb-item" href="index.php"><i class="fa fa-home tx-20"></i></a>
        ...
        <div class="sl-pagebody">
            <div class="row mt-5">
                ...
                <form action="edit-portfolio-post.php" method="POST" enctype="multipart/form-data">        
                    <div class="card pd-20 pd-sm-40">
                        <h2 class="text-primary text-center">Edit Portfolio</h2>
                        <div class="row">
                        <div class="col-md-5  mt-1 mr-2">
                            <label for="title">Portfolio Title<span class="tx-danger">*</span></label>
                            <input type="text" value="<?= $portAssoc['id'] ?>" hidden name="id">
                            <input value="<?= $portAssoc['title']; ?>" type="text" name='title' id='title' class="form-control" placeholder="Enter portfolio title">
                            ...
                            <div class="col-md-6 ml-2 mt-1">
                                ...
                                <select name="category" id="category" class="form-control">
                                    ...
                                    <option <?php if($portAssoc['category'] == 'audio'){ echo 'selected';}?> value="audio">Audio</option>
                                    <option <?php if($portAssoc['category'] == 'creative'){ echo 'selected';}?> value="creative">Creative</option>
                                    <option <?php if($portAssoc['category'] == 'design'){ echo 'selected';}?> value="design">Design</option>
                                    <option <?php if($portAssoc['category'] == 'development'){ echo 'selected';}?> value="development">Development</option>
                                    <option <?php if($portAssoc['category'] == 'ui/ux'){ echo 'selected';}?> value="ui/ux">UI/UX</option>
                                    <option <?php if($portAssoc['category'] == 'video'){ echo 'selected';}?> value="video">Video</option>
                                </select>
                                <span class="text-danger">
                                    <?php
                            ...
                            <div class="col-md-6 pt-3">
                                <label>Preview:</label>
                                <img id="thumbnailPre" src="../assets/img/portfolios/thumbnail/<?=$portAssoc['thumbnail_image']?>" height="300px" width="300px" alt="Thumbnail Image Preview:" >
                            </div>
                            <div class="col-md-5 mr-4 pt-3">
                            ...
                            <div class="col-md-6 pt-3">
                                <label>Preview:</label>
                                <img id="featuredPre" src="../assets/img/portfolios/featured/<?=$portAssoc['featured_image']?>" height="300px" width="300px" alt="Featured Image Preview:" >
                            </div>
                            <div class="col-md-12 mt-1">
                                <label for="link">Summary <span class="tx-danger">*</span></label>
                                <textarea name="summary" id="summary" cols="30" rows="10" class="form-control"><?= $portAssoc['summary'] ?></textarea>
                                 <span class="text-danger">
                                 <?php
